...
public class Test2
{
	//Keyboard - Arrow-up ,Arrow-down option selection
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(2000);
		a1.sendKeys(Keys.ARROW_DOWN).perform();	//Sep
		Thread.sleep(2000);
		a1.sendKeys(Keys.ARROW_DOWN).perform();//Oct
		Thread.sleep(2000);
		a1.sendKeys(Keys.ARROW_DOWN).perform();//Nov		
		Thread.sleep(2000);
		a1.sendKeys(Keys.ARROW_DOWN).perform();//Dec
